(() => {
  ...
  function render() {
    ...
    for (const asset of visible) {
      ...
      const kind = document.createElement("span"); kind.textContent = label(asset.identity.entity_type);
      ...
      const prototype = document.createElement("p"); prototype.textContent = `${asset.prototype.model}${asset.prototype.nickname ? ` · ${asset.prototype.nickname}` : ""}`;
